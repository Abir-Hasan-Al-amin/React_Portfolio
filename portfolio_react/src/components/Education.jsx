...
function Education() {
  return (
    <div
      name="EDUCATION"
      className="bg-[#262A33]  text-gray-300 w-full h-screen pt-14"
    >
      <div className="max-w-[1200px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="pt-10">
          ...
          <div className=" shadow-xl border-b-slate-800 p-10 hover:scale-105 duration-200">
              <p className="text-2xl p-4  text-red-500">Machine Learning Approaches for Intrusion Detection Systems: A Comparative Analysis</p>
              <p className="p-4">Currently Working...</p>
              <p className="p-4  text-red-500">Supervised By</p>
              <p className="p-4"> Dr. S M Aminul Haque</p>
              <p className="p-4">Associate Head | Department of Computer Science and Engineering</p>
